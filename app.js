...
async function getRandomImage(keyword, count) {
    ...
    let requestUrl = `https://api.unsplash.com/photos/random/?count=${count}&client_id=fYP10cyiveZ71Ijq-EUW36VL6IFSOzrJ8PdeK6Ci3hw&featured=true&orientation=landscape&query=${keyword}`;
